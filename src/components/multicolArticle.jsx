...
export class SimpleMulticalArticle extends React.Component {
    render(){
        return (
            <div id="article">
                <div className="simple_article_container" id="simple_article_container">
                ...
                <div className="simple_article_container_1" id="simple_article_container_1">
                    <h1>Simple multicol example</h1>
                ...
                <div className="simple_article_container_2" id="simple_article_container_2">
                    <h1>Simple multicol example</h1>
                ...
                <div className="simple_article_container_3" id="simple_article_container_3">
                    <h1>Simple multicol example</h1>
